...
const cardData = [
    { id: 1, image: 'https://dostguru.com/HTML/hitech/assets/img/product/product_22.jpg', star: 'star Here', title: 'Smart Watch Black', mainPrice: '$30.00', subPrice: '$40.00' },
    { id: 2, image: 'https://dostguru.com/HTML/hitech/assets/img/product/product_14.jpg', star: 'star Here', title: 'Smart Watch Black', mainPrice: '$30.00', subPrice: '$40.00' },
    { id: 3, image: 'https://dostguru.com/HTML/hitech/assets/img/product/product_18.jpg', star: 'star Here', title: 'Smart Watch Black', mainPrice: '$30.00', subPrice: '$40.00' },
    { id: 4, image: 'https://dostguru.com/HTML/hitech/assets/img/product/product_26.jpg', star: 'star Here', title: 'Smart Watch Black', mainPrice: '$30.00', subPrice: '$40.00' },
    { id: 5, image: 'https://dostguru.com/HTML/hitech/assets/img/product/product_20.jpg', star: 'star Here', title: 'Smart Watch Black', mainPrice: '$30.00', subPrice: '$40.00' },
                        ...
                        <div className='grid lg:grid-cols-2 justify-center items-center bg-white min-h-94 shadow-lg rounded-lg p-6'>
                            ...
                            <div >
                                <div className='border-b-1 border-gray-300 pb-2'>
                                    <h2 className='text-xl font-semibold'>Monster Speaker 50DB Volume</h2>
                    ...
                    <div className='hidden md:inline-block'>
                        ...
                        <div className='overflow-hidden'>
                            <div className='flex transition-all duration-500' style={{ transform: `translateX(-${(cardIndex * 100) / visibleCard}%)` }}>
                                {
                                    cardData.map((Cdata) => (
                                        <Link to={`products/${Cdata.id}`} key={Cdata.id} className='flex-none w-full sm:w-1/2 lg:w-1/3 p-2 my-5'>
                                            <div className='bg-white flex flex-col items-center min-h-[370px] shadow-md rounded-lg'>
                                                <div className='border-b-1 mt-5 w-full h-[200px] object-contain pb-3 border-gray-200'>
                                                    <img src={Cdata.image} className='w-full h-full object-contain' alt="" />
                                                </div>
                                                <div className='mt-8 flex flex-col items-center '>
                                                    <span className=' mb-1 flex text-sm text-red-600 gap-0.5'><FaStar /><FaStar /><FaStar /><FaStar /><FaStar /> </span>
